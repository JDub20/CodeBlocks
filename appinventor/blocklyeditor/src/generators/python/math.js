...
Blockly.Python.math_compare = function() {
...
Blockly.Python.math_arithmetic = function(mode, block) {
...
Blockly.Python.math_subtract = function() {
  return Blockly.Python.math_arithmetic("MINUS",this);
};

Blockly.Python.math_division = function() {
  return Blockly.Python.math_arithmetic("DIVIDE",this);
};

Blockly.Python.math_power = function() {
  return Blockly.Python.math_arithmetic("POWER",this);
};

Blockly.Python.math_add = function() {
  return Blockly.Python.math_arithmetic_list("ADD",this);
};

Blockly.Python.math_multiply = function() {
  return Blockly.Python.math_arithmetic_list("MULTIPLY",this);
};

Blockly.Python.math_arithmetic_list = function(mode,block) {
...
Blockly.Python.math_neg = function() {
  return Blockly.Python.math_single.call(this);
};
